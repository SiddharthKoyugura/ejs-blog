...
const homeStartingContent = "Share your views, solve your queries, stay concious about your health with our food blog.... Click on 'compose' to add a blog..!";
...
app.get("/posts/:test",function(req,res){
  const parameter = _.lowerCase(req.params.test);
